...
@register_model
def SvitS_224_r3_6rb_4sto_neck(pretrained=False, base_keep_rate=0.7, drop_loc=(3, 6, 9), **kwargs):
    keep_rate = [1] * 12
    for loc in drop_loc:
...
@register_model
def SvitS_288_r3_6rb_4sto_neck(pretrained=False, base_keep_rate=0.6, drop_loc=(3, 6, 9), **kwargs):
    keep_rate = [1] * 12
    for loc in drop_loc:
        keep_rate[loc] = base_keep_rate
    model_kwargs = dict(patch_size=16, embed_dim=384, depth=12, num_heads=6, keep_rate=keep_rate, base_keep_rate=base_keep_rate, save_tokens=4)
...
if __name__ == "__main__":
    ...
    model = SvitS_224_r3_6rb_4sto_neck(base_keep_rate=0.7)
    img_size = 224
