...
@register_model
def SvitS_224_r3_6rb_4sto_neck_rploss(pretrained=False, base_keep_rate=0.7, drop_loc=(3, 6, 9), **kwargs):
    keep_rate = [1] * 12
    for loc in drop_loc:
...
if __name__ == "__main__":
    ...
    model = SvitS_224_r3_6rb_4sto_neck_rploss(base_keep_rate=0.7)
    img_size = 224
