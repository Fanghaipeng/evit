...
@register_model
def deit_small_patch16_shrink_base_r4_tt0_lfb_4sto(pretrained=False, base_keep_rate=0.7, drop_loc=(3, 6, 9), **kwargs):
    keep_rate = [1] * 12
    for loc in drop_loc:
...
if __name__ == "__main__":
    ...
    model = deit_small_patch16_shrink_base_r4_tt0_lfb_4sto(base_keep_rate=0.7)
